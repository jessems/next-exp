...
This article can be see as a follow up to my previous two guides.

I wrote one tutorial on [how to add a button to the UI Bar](/configurable-workspaces/declarative-actions/ui-action-bar) of a configurable workspace.

I wrote a second tutorial on [how to make that button open a modal](opening-a-modal-with-declarative-actions.mdx).
