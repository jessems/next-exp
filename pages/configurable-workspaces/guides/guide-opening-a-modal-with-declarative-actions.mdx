...
This tutorial assumes you already have a button configured inside Configurable Workspaces. If not, you can follow the preceding tutorial to do so [here](./guide-adding-a-button-to-the-ui-action-bar.mdx).
</Callout>
